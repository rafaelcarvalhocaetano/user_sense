...
//}
//
//func NewTemplateMeta(db whatsapp.Repository, http services.WTAGateway) *TemplateMeta {
//	return &TemplateMeta{db: db, http: http}
//}
//
//func (temp *TemplateMeta) GetTemplateMeta(input map[string]string) (*[]entities.TemplateMetaModel, error) {
//	resp, err := temp.http.GetDataModel("message_templates", input)
//	if err != nil {
//		return nil, err
//	}
//
...
//}
//
//func (temp *TemplateMeta) GetTemplateMetaWithPhone(phone string, input map[string]string) (
//	[]entities.TemplateMetaModel, error) {
//	resp, err := temp.http.GetDataModel("message_templates", input)
//	if err != nil {
//		return nil, err
//	}
//
//	model, err := temp.execute(phone, resp)
//	if err != nil {
//		return nil, err
//	}
//
...
//}
//
//func (temp *TemplateMeta) execute(phone string, resp map[string]any) (*[]entities.TemplateMetaModel, error) {
